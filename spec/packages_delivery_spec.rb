...
describe Packages_delivery do
  ...
  it "should load data from file" do
    ...
    delivery = @packages_delivery
    @packages_delivery.save_to_file("./t.yml")
    @packages_delivery = @packages_delivery.load_from_file("./t.yml")
    delivery.should have_same_data(@packages_delivery)
  end
  it "should save data to file" do
     ...
     @packages_delivery.save_to_file(filename)
     filename.should be_same_file_as"./data.yml"
  end
end
